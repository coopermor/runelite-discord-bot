export default {
  ...
  channels: {
    ...
    // channels where /whois should include moderator notes
    notesChannels: ['contributors', 'moderators']
  },
  roles: {
  ...
  spam: {
    ...
    // Amount of time (ms) in which old messages are considered for edit filtering
    editFilterMaxAge: 86_400_000, // 24 hours
